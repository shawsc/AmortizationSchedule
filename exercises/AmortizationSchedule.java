...
public class AmortizationSchedule {
	...
	public static void main(String [] args) {
        ...
        for (String s: args) {
            if (s.equals("test")) {
                AmortizationScheduleModelTest tester = new AmortizationScheduleModelTest();
                tester.testGenerateAmortizationSchedule();
                tester.testCalculateMonthlyPayment();
                tester.testGenerateAmortizationScheduleHighAPR();
                tester.testGenerateAmortizationScheduleLowAPR();
                tester.testGenerateAmortizationScheduleHighBorrow();
                tester.testGenerateAmortizationScheduleLowBorrow();
                tester.testGenerateAmortizationScheduleHighTerm();
                tester.testGenerateAmortizationScheduleLowTerm();
                return;
            }
        }
        AmortizationScheduleModel theModel = new AmortizationScheduleModel();

        AmortizationScheduleView theView = new AmortizationScheduleView(
                theModel.getBorrowAmountRange()[0].doubleValue(),
                theModel.getBorrowAmountRange()[1].doubleValue(),
                theModel.getAPRRange()[0].doubleValue(),
                theModel.getAPRRange()[1].doubleValue(),
                theModel.getTermRange()[0].intValue(),
                theModel.getTermRange()[1].intValue());
        AmortizationScheduleController theController = new AmortizationScheduleController(theModel,theView);
        theController.DoAmortizationSchedule();
